...
pub fn run() {
    ...
    // Image
    let img_data = include_bytes!("../assets/static/star.png");
    ...
    let pipeline = {
        let vs_module = {
            let glsl = fs::read_to_string("source_assets/shaders/quad.vert").unwrap();
        ...
        let fs_module = {
            let glsl = fs::read_to_string("source_assets/shaders/quad.frag").unwrap();
